...
if __name__ == '__main__':
    ...
    NUM_WORKERS = 1
    train_ds_all = torchvision.datasets.CIFAR100(root='/lustre/home/wzliu/datasets', train=True, download=True,
    ...
    test_ds_all = torchvision.datasets.CIFAR100(root='/lustre/home/wzliu/datasets', train=False, download=True,
